...
class Lamp:
    def __init__(self, pinA, pinB):
        ...
        self.percentWarm = 100 # 60% warm and 40% cold
    ...
    def setMixPercent(self, val):
        #print(val)
        self.percentWarm = val
        self.lighting(self.current)
    ...
    def lighting(self, value):
        ...
        valWarm = int(constant*self.percentWarm)
        valCold = value - valWarm

        self.pwmOutput(self.fader[valWarm], self.fader[valCold]) # apply correction for humain eyes
        self.current = value

    def pwmOutput(self, valA, valB):
        """Convert from 0-255 to 0-1023 and send to PWM driver"""
        self.pwm0.duty(valA << 2)
        self.pwm1.duty(valB << 2)
